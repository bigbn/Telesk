...
class Ui_Contacts(object):
    def setupUi(self, Form):
        ...
        self.cscrollArea.setStyleSheet("""background: rgb(40,40,40);
                                        border-color: rgb(50,50,50)""")
        self.cscrollArea.setWidgetResizable(True)
        self.cscrollAreaWidgetContents = QtGui.QWidget()
        self.cscrollAreaWidgetContents.setStyleSheet("""background:
                                                        rgb(40,40,40);
                                                        border-color:
                                                        rgb(50,50,50)""")
        ...
        self.scrollArea.setStyleSheet("""background: rgb(40,40,40);
                                        border-color: rgb(50,50,50)""")
        self.scrollArea.setWidgetResizable(True)
        self.scrollAreaWidgetContents = QtGui.QWidget()
        self.scrollAreaWidgetContents.setStyleSheet("""background:
                                                     rgb(40,40,40);
                                                     border-color:
                                                     rgb(50,50,50)""")
